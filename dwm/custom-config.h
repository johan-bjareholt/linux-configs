...
static const char selbordercolor[]  = "#103388";
static const char selbgcolor[]      = "#103388";
...
static int opacity                  = 255; /* statusbar transparency*/
static const char clock_fmt[]       = "%m:%d %H:%M";
